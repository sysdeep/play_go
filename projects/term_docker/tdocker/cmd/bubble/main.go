		...
		options: []menuItem{
			{
				...
				onPress: func() tea.Msg { return gotoPageMsg{state.PAGE_CONTAINERS} },
			},
			{
				text: "Images",
				// onPress: func() tea.Msg { return toggleCasingMsg{} },
				onPress: func() tea.Msg { return gotoPageMsg{state.PAGE_IMAGES} },
			},
			{
				text: "Volumes",
				// onPress: func() tea.Msg { return toggleCasingMsg{} },
				onPress: func() tea.Msg { return gotoPageMsg{state.PAGE_VOLUMES} },
			},
			{
				text: "Networks",
				// onPress: func() tea.Msg { return toggleCasingMsg{} },
				onPress: func() tea.Msg { return gotoPageMsg{state.PAGE_NETWORKS} },
			},
			// {
			// 	text:    "exit",
